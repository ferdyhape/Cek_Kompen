...
<head>
    ...
    <title>Cek Kompen MHS POLINEMA</title>
</head>
        ...
        <div class="col-xs-8 col-sm-4 mt-5">
            <div class="card shadow-sm border-0">
                <div class="card-header text-muted d-flex justify-content-between">
                    ...
                    <a href="https://github.com/ferdyhape" class="my-auto text-dark" target="_blank"><i
                            class="fa-brands fa-github" style="font-size: 30px;"></i></a>
                </div>
